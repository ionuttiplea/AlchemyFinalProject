...
export interface DiamondLoupeFaucetInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "facetAddress"
      | "facetAddresses"
...
export interface DiamondLoupeFaucet extends BaseContract {
  connect(runner?: ContractRunner | null): DiamondLoupeFaucet;
  waitForDeployment(): Promise<this>;

  interface: DiamondLoupeFaucetInterface;
